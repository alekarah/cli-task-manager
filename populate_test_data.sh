...
echo "  - 3 задачи с дедлайнами (включая 1 просроченную)"
echo "  - 6 задач с тегами (backend, api, devops, и др.)"
echo ""
