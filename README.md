...
Скрипт создаст 10 задач с разными статусами и датами:
...
7. `search` - поиск задач по тексту
8. `sort` - сортировка задач (по ID, дате создания, дате обновления, статусу)
...
- [x] Поиск по задачам
- [x] Сортировка задач (по дате, приоритету)
